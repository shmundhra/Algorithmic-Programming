...
long long modexpCALC ( long long base , long long expo , long long modulo )
{  
...
int main () 
{
    ...
    tc(t)
    {
        ...
        if ( y == 0 )
        {
            ans= ( modexpCALC( a, n, MOD ) + modexpCALC( b, n, MOD ) ) ; 
        }
        else
        {
            ans= gcd ( y , ( modexpCALC( a, n, y ) + modexpCALC( b, n, y ) ) % y ) ;             
        }
        ans %= MOD ; 
        cout<<ans<<"\n" ; 
